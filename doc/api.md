...
Для заданий используется поле *priority*, которые может принимать следующие значения (от самого низкого к самому высокому): "VERY_LOW", "LOW", "MEDIUM", "HIGH", "VERY_HIGH", регистр игнорируется.
